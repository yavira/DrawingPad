...
public class DrawingPad extends Scribble {
  ...
  protected void initTools() {
    ...
    toolkit.addTool(new TwoEndsTool(canvas, "Line", TwoEndsTool.getLINE()));
    toolkit.addTool(new TwoEndsTool(canvas, "Oval", TwoEndsTool.getOVAL()));
    toolkit.addTool(new TwoEndsTool(canvas, "Rectangle", TwoEndsTool.getRECT()));
